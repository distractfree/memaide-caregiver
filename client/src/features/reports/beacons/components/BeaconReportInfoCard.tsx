...
export function BeaconReportInfoCard() {
  return (
    <div
    ...
    >
      ...
      <div className="min-w-0 text-sm">
        ...
        <p className="mt-0.5 text-on-surface-variant">
          Signal strength can vary by phone, room layout, and interference. Events are best-effort
          caregiver coordination data, not exact indoor location, fall detection, or a medical
          device.
        </p>
      </div>
    </div>
